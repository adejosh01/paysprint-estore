...
const Home = () => (
    <div className="container">
      ...
      <div className="dahsboard-local-money-tf">
              ...
              <div className="frame-servicesx">
                    <div className="frame-372">
                      ...
                      <div className="frame-361">
                        ...
                        <a href="/dashboard/services/payinvoice" className="pay-invoice">Pay invoice</a>
                        <a href="/dashboard/services/utility" className="utility-bills">Utility bills</a> 
        ...
        <div className="frame-381xx">
          <div className="frame-378">
            <a href="/dashboard/services" className="frame-part">
              <p className="non-pay-sprint-user">PaySprint User</p>
            </a>
            <a href="/dashboard/services/non-paysprint" className="frame-3782xx">
              <p className="non-pay-sprint-user">Non-PaySprint User</p>
            </a>
            <a href="#" className="frame-380xx">
              <p className="pay-sprint-user"> Saved Beneficiary</p>
            </a>
          </div>

          <div className="frame-3823x">
            <p className="account-number">Account number</p>
            <div className="frame-num">
              <p className="_3299265">3299265</p> 
            </div>
          </div>
          <p className="notify">
            Send money to any of your saved beneficiaries or send to multiple beneficiaries at the same time.
          </p>
          <button type="button" className="frame-proceedx2">
          ...
          <div className="frame-309-xx">
                <p className="description">Name</p>
                <p className="amount">Account No</p>
                <div className="frame-326x">
                  <p>
                    Send to multiple benficiaries
                  </p>
                </div>
          </div> 
          ...
          <div className="frame-434">
            <div className="frame-431">
              <div className="frame-4322">
                <div className="frame-430">
                  <input type="checkbox" className="checkbox" />
                  <p> Shalom Adebiyi Professionals File Account </p>
                </div>
                <div className="_35443">35443</div>
              </div>
              <div className="frame-433">
                <div className="send-money2">Send Money</div>
                <svg
                ...
                >
                  <path
                    d="M10.6792 10.1642L4.4032 11.2102C4.2562 11.2347 4.13349 11.3358 4.08135 11.4754L1.91644 17.2732C1.70921 17.8062 2.26706 18.3145 2.77845 18.0588L17.7784 10.5588C18.2391 10.3285 18.2391 9.67108 17.7784 9.44075L2.77845 1.94079C2.26706 1.68509 1.70921 2.19347 1.91644 2.72633L4.08135 8.52417C4.13349 8.66375 4.2562 8.76492 4.4032 8.78942L10.6792 9.83542C10.77 9.8505 10.8313 9.93642 10.8162 10.0272C10.8045 10.0974 10.7495 10.1525 10.6792 10.1642Z"
                    fill="#E7AA07"
                  />
                </svg>
              </div>
            ...
            <div className="frame-431">
              <div className="frame-4322">
                ...
                <div className="_35443">93581</div>
              </div>
              <div className="frame-433">
                <div className="send-money2">Send Money</div>
                <svg
            ...
            <div className="frame-431">
              <div className="frame-4322">
                ...
                <div className="_35443">69212</div>
              </div>
              <div className="frame-433">
                <div className="send-money2">Send Money</div>
                <svg
