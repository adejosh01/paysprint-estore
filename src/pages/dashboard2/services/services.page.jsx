      ...
      <div className="dahsboard-local-money-tf">
        ...
        <div className="frame-381">
          <div className="frame-378">
            <a href="#" className="frame-3782">
              <p className="pay-sprint-user">PaySprint User</p>
            </a>
            <a href="/dashboard/services/non-paysprint" className="frame-379">
              <p className="non-pay-sprint-user">Non-PaySprint User</p>
            </a>
            <a href="/dashboard/services/saved" className="frame-380">
              <p className="beneficiary">Saved Beneficiary</p>
            </a>
          </div>
          <div className="frame-3823">
          ...
          <p className="notify">
            PaySprint offers a seamless and secure platform for sending money
            locally. Please enter your preferred receiver’s PaySprint account
            number below , and send funds to anyone with no hidden fees.
          </p>
          <button type="button" className="frame-proceedx">
          ...
          <div className="frame-411">
            <svg
              className="checkmark-circle-undefined-glyph-undefined"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div className="frame-410">
              <div className="frame-4122">
                <p className="nameT">Oluwaseunbabara Taiwo</p>
                <p className="_32992652">3299265</p>
              </div>
              <p className="address">
                2 Samuel Ike Street, Isolo<br />Lagos, Nigeria
              </p>
            </div>
          </div>
        </div>
