...
const overviewClass = page === 'dashboard' ? 'frame-38 active' : 'frame-39';
const walletClass = page === '/wallet' ? 'frame-38 active' : 'frame-39';
const transactionsClass = page === '/dashboard/transactions' ? 'frame-38 active' : 'frame-39';
const servicesClass = page === '/dashboard/services' ? 'frame-38 active' : 'frame-39';
const promotionsClass = page === '/dashboard/promotions' ? 'frame-38 active' : 'frame-39';
    ...
    return ( 
        ...
        <div className="frame-41">
          <div className="frame-38">
            <div className="frame-33">
              ...
              <Link className='promotions' href="/dashboard">
                Overview
              </Link>
            </div>
          </div>
          ...
          <div className={walletClass}>
            <div className="frame-34">
              ...
              <Link className='promotions' to="/dashboard/wallet">
                Wallet
              </Link>           
            </div>
          </div>
          ...
          <div className={transactionsClass}>
            <div className="frame-35">
              ...
              <Link className='promotions' to="/dashboard/transactions">
                Transactions
              </Link>                       
            </div>
          </div>
          ...
          <div className={servicesClass}>
            <div className="frame-37">
              ...
              <Link className='promotions' to="/dashboard/services">
                Services
              </Link>              
              <svg
                className="frame-353"
          ...
          <div className={promotionsClass}>
            <div className="frame-37">
              ...
              <Link className='promotions' to="/dashboard/promotions">
                Promotions
              </Link> 
            </div>
          </div>
        ...
        <div className="frame-412">
          ...
          <div className="frame-382">
            <button type='button' className="frame-33">
              <svg
                className="log-out"
                width="20"
                height="20"
        ...
        <img className="image-43" src="assets/images/image-43.png" alt="logo" />
